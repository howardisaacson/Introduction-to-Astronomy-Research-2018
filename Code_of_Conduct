...
Our values strongly align with those put forth by the Software Carepentry group, and we adopt their code as our own. The original Code of Conduct for Software Carpentry can be found here (https://docs.carpentries.org/topic_folders/policies/code-of-conduct.html).
